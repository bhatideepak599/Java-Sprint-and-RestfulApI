...
public class EmployeeController {
	...
	public ResponseEntity<List<ResponseDto>> getAllEmployees() {
		...
		return new ResponseEntity<List<ResponseDto>>(employeeService.getAll(), HttpStatus.OK);
	}
	...
	public ResponseEntity<ResponseDto> getEmployeeById(@Valid @PathVariable(name = "sid") int id) {
		...
		return new ResponseEntity<ResponseDto>(employeeService.getEmployeeById(id), HttpStatus.OK);
	...
	public ResponseDto addEmployee(@Valid @RequestBody RequestDto employee) {
		...
		ResponseDto dto = employeeService.saveEmployee(employee);
		return dto;
	}
	...
	public ResponseEntity<ResponseDto> updateEmployee(@Valid @RequestBody RequestDto employee) {
		...
		return new ResponseEntity<ResponseDto>(employeeService.updateEmployee(employee), HttpStatus.OK);
