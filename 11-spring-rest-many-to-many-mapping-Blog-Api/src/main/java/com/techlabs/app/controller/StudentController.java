...
public class StudentController {
    ...
    public ResponseEntity<Student> addStudentToACourse(@PathVariable("studentId") int studentId,
    		@PathVariable("courseId") int courseId) {
        
        Student getStudent = studentService.addStudentToACourse(studentId,courseId);
        return new ResponseEntity<>(getStudent, HttpStatus.OK); 
    }
